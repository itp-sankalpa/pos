...
from ui.theme import (
    ...
    COLOR_BORDER, COLOR_ACCENT, COLOR_SUCCESS, COLOR_SUCCESS_BG,
    COLOR_WARNING, COLOR_ERROR, COLOR_ERROR_BG, COLOR_INFO,
    COLOR_SELECTED_ROW_BG, FONT_FAMILY, FONT_PAGE_TITLE, FONT_SECTION_TITLE,
    FONT_BODY, FONT_BUTTON, FONT_SMALL, FONT_GRAND_TOTAL, FONT_MONO,
    FONT_RECEIPT, SPACING_XS, SPACING_SM, SPACING_MD, SPACING_LG, SPACING_XL,
    BUTTON_HEIGHT, INPUT_HEIGHT, RECEIPT_CHARS_80MM, RECEIPT_CHARS_58MM,
    status_badge_colors,
)
